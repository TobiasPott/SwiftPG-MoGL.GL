...
struct MoGLPersist {
    ...
    static func save(_ tfs: Transform, _ prefix: String = "transform") {
        let ud = UserDefaults.standard
        ud.setValue(tfs.x, forKey: prefix + ".location.x")
        ud.setValue(tfs.y, forKey: prefix + ".location.y")
        ud.setValue(tfs.z, forKey: prefix + ".z")
    ...
    static func delete(_ tfs: Transform, _ prefix: String = "transform") {
        let ud = UserDefaults.standard
        ud.removeObject(forKey: prefix + ".location.x")
        ud.removeObject(forKey: prefix + ".location.y")
        ud.removeObject(forKey: prefix + ".z")
